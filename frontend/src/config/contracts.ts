export const PHANTOM_PAD_ADDRESS = '0xD8B09449aea96C9887DE6eF4855164bE55Cd8A37' as const;
export const CONFIDENTIAL_USDC_ADDRESS = '0x791A7194c53FA5B42d680D9462F91B5A2Fd0ceF0' as const;

export const PHANTOM_PAD_ABI = [
  {
    "inputs": [
      {
